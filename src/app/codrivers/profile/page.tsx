      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Click any co-driver name to view their detailed profile
          </p>
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-lg p-8">
          <h2 className="text-2xl font-bold text-white mb-6">Championship Standings - Click Names for Profiles</h2>
          
          {championshipStandings.length > 0 ? (
            <div className="space-y-4">
              {championshipStandings.map((coDriver: AggregatedCoDriver, index: number) => (
                <div key={coDriver.name} className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-lg p-6 border border-gray-600">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <Link 
                          ...
                          className="text-white font-semibold text-2xl hover:text-blue-300 transition-colors cursor-pointer underline decoration-blue-400 decoration-2 underline-offset-4"
                        >
                          {coDriver.name}
                        </Link>
                        ...
                        <div className="text-blue-400 text-sm mt-1">
                          Click name above to view detailed profile →
                        </div>
                      </div>
                    </div>
        ...
        <div className="bg-yellow-900/20 border border-yellow-500/50 rounded-lg p-6 mt-8">
          ...
          <p className="text-gray-300">
            Click any co-driver name above to view their complete profile with rally-by-rally points breakdown, 
